package com.yuki.vision.app.utils
        ...
        private val isMIUI6Later: Boolean
            get() {
                return try {
                    ...
                    var string = method.invoke(null, "ro.miui.ui.version.name") as String
                    string = string.replace("[vV]".toRegex(), "")
                    val version = Integer.parseInt(string)
                    version >= 6
                } catch (e: Exception) {
                    false
                }
