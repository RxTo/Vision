...
/**
 * ================================================
 * 本框架由 MVVM + Dagger2 + Retrofit + RxJava2 + RxCache 组成
 * ================================================
 */
public class XApplication extends Application implements IApp {
    private AppDelegate mAppDelegate;

    /**
     * 这里会在 {@link XApplication#onCreate} 之前被调用,可以做一些较早的初始化
